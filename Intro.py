...
def funct_intro():
    ...
    st.warning('Also, for the next release the application will be more rapid, when using some models like the SARIMA you might facing slowness, the code will be more efficient.')
    # =============================================================================
    # CSS sidebar  
    # =============================================================================
